...
public class ComObjectParameterChoose extends KnxBase {
    ...
    private java.util.List<ComObjectParameterChoose_when> When = new java.util.ArrayList<>();
    ...
    public java.util.List<ComObjectParameterChoose_when> getWhen() { return When; }
    public void setWhen(java.util.List<ComObjectParameterChoose_when> value) { this.When = value; }
}