...
public class DatapointType extends KnxBase {
    ...
    private String PDT;
    @JacksonXmlProperty(localName = "DatapointSubtypes")
    private DatapointType_DatapointSubtypes DatapointSubtypes = null;
    ...
    public DatapointType_DatapointSubtypes getDatapointSubtypes() { return DatapointSubtypes; }
    public void setDatapointSubtypes(DatapointType_DatapointSubtypes value) { this.DatapointSubtypes = value; }
}