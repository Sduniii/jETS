...
public class DependentChannelChoose extends KnxBase {
    ...
    private java.util.List<DependentChannelChoose_when> When = new java.util.ArrayList<>();
    ...
    public java.util.List<DependentChannelChoose_when> getWhen() { return When; }
    public void setWhen(java.util.List<DependentChannelChoose_when> value) { this.When = value; }
}