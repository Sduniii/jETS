...
public class LdCtrlBaseChoose extends KnxBase {
    ...
    private java.util.List<LdCtrlBaseChoose_when> When = new java.util.ArrayList<>();
    ...
    public java.util.List<LdCtrlBaseChoose_when> getWhen() { return When; }
    public void setWhen(java.util.List<LdCtrlBaseChoose_when> value) { this.When = value; }
}