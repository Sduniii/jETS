...
public class LdCtrlMasterReset extends KnxBase {
    ...
    @JacksonXmlProperty(isAttribute = true, localName = "EraseCode")
    private short EraseCode;
    @JacksonXmlProperty(isAttribute = true, localName = "ChannelNumber")
    ...
    public short getEraseCode() { return EraseCode; }
    public void setEraseCode(short value) { this.EraseCode = value; }
    public short getChannelNumber() { return ChannelNumber; }
    public void setChannelNumber(short value) { this.ChannelNumber = value; }
