...
public class LdCtrlRelSegment extends KnxBase {
    ...
    public void setMode(short value) { this.Mode = value; }
    public short getFill() { return Fill; }
    public void setFill(short value) { this.Fill = value; }
