...
public class UnionParameter extends KnxBase {
    ...
    @JacksonXmlProperty(isAttribute = true, localName = "DefaultUnionParameter")
    private boolean DefaultUnionParameter;
    ...
    public boolean getDefaultUnionParameter() { return DefaultUnionParameter; }
    public void setDefaultUnionParameter(boolean value) { this.DefaultUnionParameter = value; }
}